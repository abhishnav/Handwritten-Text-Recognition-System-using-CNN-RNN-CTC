...
def infer(model: Model, img_dir: Path) -> None:
    """Recognizes text in images provided by directory path."""
    recognized_lines = []
    ...
    # Concatenate all recognized lines with spaces
    final_output = ' '.join(recognized_lines)
    print(f'Final Recognized Text: "{final_output}"')
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--img_file', help='Directory containing segmented line images.', type=Path, default='SimpleHTR/outputs/line_crops')
